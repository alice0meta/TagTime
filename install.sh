...
{ if [[ "$1" ]]; then "$1/build.sh" "$PWD/t.tar.gz"; else curl -o t.tar.gz "https://raw.githubusercontent.com/alice0meta/TagTime/dl/tagtime-latest-osx.tar.gz"; fi; } && tar -zxf t.tar.gz && rm t.tar.gz
unzip -q tagtime.nw
